...
import { addNewQuote, deleteQuote, getAllQuotes, likeQuote } from "../controllers/quotes-controller";
...
router.patch("/like", body("quoteId").isString(), authenticateUserAccessToken, likeQuote);
